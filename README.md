...
```sh
  cd my-folder
  git clone https://github.com/edenlisk/Awesome-Books.git

  cd Awesome-books-package-management
  npm run build
```
...
Feel free to check the [issues page](https://github.com/edenlisk/Awesome-Books/issues).
